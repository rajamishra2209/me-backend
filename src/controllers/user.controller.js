...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // checking input field is empty or not while filling the form
  if (
  ...
  // checking whether user is already reegistered or not
  ...
  //setting up avatar and cover image file location
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  // cookies
  const options = {
    httpOnly: true, // when we make httpOnly and secure is true thn it won't be modifyable by frontend it can be modified only on server
    secure: true,
  };
  return res
    .status(200)
